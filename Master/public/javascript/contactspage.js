...
//need to remove the buttons for the create page in the nav bar an put logout instead
...
function init_map() {
  ...
  L.tileLayer(
    'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}',
    {
      ...
      accessToken:
        "pk.eyJ1IjoiYnN0cnVjayIsImEiOiJja2l5NXdpYzgwMWlnMnR0ZHB4dnJueWkwIn0.Ui0oIcy1eAGQ3ACALMO14w",
    }
  ).addTo(mymap);
}
